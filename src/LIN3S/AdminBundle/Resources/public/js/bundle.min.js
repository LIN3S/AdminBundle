...
var onReady = function onReady() {
  (0, _lin3sFrontFoundation.initParsley)();
...
exports.initParsley = undefined;

var _parsleyFormError = __webpack_require__(10);

var _parsleyFormError2 = _interopRequireDefault(_parsleyFormError);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.initParsley = _parsleyFormError2.default;
...
var _parsleyjs = __webpack_require__(11);
...
var initParsley = function initParsley() {
  ...
  _parsleyjs2.default.setLocale(locale);
};

exports.default = initParsley;
...
if (typeof Array.from === 'undefined') {
  Array.from = __webpack_require__(15); // eslint-disable-line no-undef
}
...
var onReady = function onReady() {
  ...
  (0, _jquery2.default)('.filter__filter-by').on('change', function () {
    $options.children().addClass('filter__option--hidden').attr('name', '');
    $options.find('[data-filter-field="' + (0, _jquery2.default)(undefined).val() + '"]').removeClass('filter__option--hidden').attr('name', 'filter').trigger('focus');
  });
};
...
var addFormType = function addFormType($aCollectionHolder) {
  ...
  var $formCollectionAddButtons = (0, _jquery2.default)('.js-collection-add'),
      $formCollectionRemoveButtons = (0, _jquery2.default)('.js-collection-remove'),
      $formToggles = (0, _jquery2.default)('.form__collection-item-toggle');

  Array.from($formCollectionAddButtons).forEach(function (formCollectionAddButton) {
    var $formCollectionAddButton = (0, _jquery2.default)(formCollectionAddButton);

    $formCollectionAddButton.on('click', function () {
      var $collectionHolder = $formCollectionAddButton.closest('.form__collection').find('.form__collection-items').first();
  ...
  Array.from($formCollectionRemoveButtons).forEach(function (formCollectionRemoveButton) {
    var $formCollectionRemoveButton = (0, _jquery2.default)(formCollectionRemoveButton);
    $formCollectionRemoveButton.closest('.form__collection-item').remove();

    return false;
  });

  Array.from($formToggles).forEach(function (formToggle) {
    var $formToggle = (0, _jquery2.default)(formToggle);
...
var onReady = function onReady() {
  var $menuToggle = (0, _jquery2.default)('.menu-toggle');

  $menuToggle.on('click', function () {
    var $menu = $menuToggle.closest('.menu');
...
var onReady = function onReady() {
  var $panelHeaders = (0, _jquery2.default)('.panel__header');

  Array.from($panelHeaders).forEach(function (panelHeader) {
    var $panelHeader = (0, _jquery2.default)(panelHeader);
