...
if (typeof Array.from === 'undefined') {
  Array.from = __webpack_require__(7); // eslint-disable-line no-undef
}
...
var Collection = function () {
  ...
  _createClass(Collection, [{
    ...
    value: function initializeObservers() {
      ...
      _lin3sEventBus.NodeAddedObserver.subscribe('js-collection-add', function (nodeAddedEvent) {
        return _this.bindAddListeners(nodeAddedEvent.nodes);
      });

      _lin3sEventBus.NodeAddedObserver.subscribe('js-collection-remove', function (nodeAddedEvent) {
        return _this.bindRemoveListeners(nodeAddedEvent.nodes);
      });
    }
  }, {
    key: 'bindAddListeners',
    value: function bindAddListeners() {
      var _this2 = this;

      Array.from(this.addButtons).forEach(function (addButton) {
    ...
    value: function bindRemoveListeners() {
      ...
      Array.from(this.removeButtons).forEach(function (removeButton) {
        removeButton.addEventListener('click', _this3.onClickRemoved);
      });
    }
  }, {
    key: 'bindToggleListeners',
    value: function bindToggleListeners() {
      var _this4 = this;

      Array.from(this.toggles).forEach(function (toggle) {
        toggle.addEventListener('click', _this4.onClickToggled);
      });
    }
  }, {
    key: 'onClickAdded',
    value: function onClickAdded(event) {
      ...
      var collectionHolder = event.currentTarget.closest('.form__collection').querySelectorAll('.form__collection-items')[0];
    ...
    value: function addFormType(collectionHolder) {
      ...
      var prototypeName = collectionHolder.getAttribute('data-prototype-name'),
    ...
    key: 'onClickToggled',
    value: function onClickToggled(event) {
      var collectionHolder = event.currentTarget,
          collectionItem = collectionHolder.closest('.form__collection-item');
